...
const socials = [
  ...
  {
    name: "Discord",
    url: "https://discord.com/users/hawari",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
  name: "TikTok",
  url: "https://tiktok.com/@usernamekamu",
  icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-md mx-auto mb-10 leading-relaxed">
            Mau collab, nanya sesuatu, atau sekedar ngobrol? Reach out ke gw lewat sosmed di bawah!
          </p>
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            {socials.map((social) => (
              <a
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-full border border-white/10 bg-white/5 text-gray-400 hover:border-purple-400 hover:text-purple-400 transition-all"
        ...
        >
          <span className="text-gray-600 text-sm">
            © {new Date().getFullYear()} Hawari. All rights reserved.
          </span>
          <span className="text-gray-600 text-sm">
